...
def classify(*,image_type,modality,task,status=None,device="",dosimeter="",manufacturer="",
    ...
    if reference_image:
        ...
        result["class"]=("ExacTrac" if "exactrac" in device.casefold() or 'brainlab' in manufacturer.casefold() else
